...
def LP(string):
    ...
    for centre in range(0, n - 1):
        ...
        #if moves != 0:
        #    print("found a new one:", string[left_pointer+1:right_pointer], moves * 2)
...
def tests():
    ...
    assert LP("yaijkjjkiauioqikapksskksskpa") == 12
    assert LP("apksskksskpayaijkjjkiauioqik") == 12
    assert LP("yaijkjapksskksskpajkiauioqik") == 16
    print("LP pass")
    ...
    assert LP2("abacdc") == 5
    assert LP2("baxyzabcdc") == 7
    assert LP2("bbacdea") == 4
    print("LP2 pass")
